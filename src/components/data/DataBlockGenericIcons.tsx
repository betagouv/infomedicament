...
import { AnsmSpecialiteWithStatus, DetailedSpecialite, ResumeSpecialite, ShortSpecialite } from "@/types/SpecialiteTypes";

interface DataBlockGenericIconsProps extends HTMLAttributes<HTMLDivElement> {
  specialite: Specialite | DetailedSpecialite | ShortSpecialite | ResumeSpecialite | AnsmSpecialiteWithStatus;
