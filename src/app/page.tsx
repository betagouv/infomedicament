        ...
        <div className={fr.cx("fr-grid-row", "fr-grid-row--gutters")}>
          <div className={fr.cx("fr-col-12", "fr-col-lg-9", "fr-col-md-10")}>
            <form action="/rechercher">
              ...
              >
                Des réponses fiables à toutes vos questions sur les médicaments
              </h1>
              ...
              <p className="fr-text--sm">
                <em>Exemples d&apos;utilisation&nbsp;:</em>
                <br />
                Vous cherchez <b>la notice</b> d’un médicament.
                <br />
                Vous voulez connaître tous les médicaments qui contiennent la
                même <b>substance active</b> (ex : paracétamol).
                <br />
                Vous voulez savoir quels sont les médicaments prescrits pour une{" "}
                <b>pathologie</b> (ex : diabète).
                <br /> Vous voulez tout comprendre d’une{" "}
                <b>classe de médicaments</b> (ex : antibiotiques).
              </p>
            </form>
          </div>
          <div
