...
import { getPresentationName, isAbrogee, isAgree, isArret, isIVG, isListeRetrocession, isListeSus } from "./presentations";
...
describe("utils presentations", () => {
  ...
  it("getPresentationName - when PVC-Alumunium + PVC in the details only display PVC-Aluminium", async () => {
    ...
    const shortPresentationName: string = getPresentationName(presentations[0], false);
  ...
  it("getPresentationName - multiple presentations", async () => {
    ...
    const shortPresentationNameA: string = getPresentationName(presentations[0], false);
    ...
    const shortPresentationNameB: string = getPresentationName(presentations[1], false);
  ...
  it("getPresentationName - abrogée status", async () => {
  ...
  it("getPresentationName - arrêtée status", async () => {
  ...
  it("getPresentationName - agréée status", async () => {
  ...
  it("getPresentationName - liste sus status", async () => {
  ...
  it("getPresentationName - liste retrocession status", async () => {
  ...
  it("getPresentationName - IVG status", async () => {
