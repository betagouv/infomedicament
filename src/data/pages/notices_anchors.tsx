...
export const questionsList: QuestionsListFormat = {
  ...
  pediatrie: {
    ...
    queryText: "Utilisation chez les enfants, adolescents et nourrissons",
    unique: false,
    tracking: "Enfants",
    icon: "enfants.svg",
  },
  grossesse: {
    ...
    queryText: "Grossesse, allaitement et fertilité — peut-on prendre ce médicament ?",
    unique: false,
  ...
  boireManger: {
    ...
    queryText: "Interactions avec l'alcool, les aliments et les boissons",
    unique: false,
  ...
  conduite: {
    ...
    queryText: "Conduite de véhicules et utilisation de machines",
    unique: true,
    tracking: "Conduite",
    icon: "conduite.svg",
  },
